...
const QRcode = ({ navigation }: Props) => {
  ...
  useEffect(() => {
    const timeIdpop = setInterval(() => {
      setCountdownpop((prevState) => prevState - 1);
    }, 1000);

    return () => clearInterval(timeIdpop);
  }, []);
  ...
  }, [countdownpop, modalcb, navigation]);
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.Popuptext2}>
              Thời gian thực hiện quy trình đã kết thúc, bạn có cần thêm thời gian không
            </Text>
